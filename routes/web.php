...
Route::get('checkout', [PageController::class, 'getCheckout'])->name('dathang');				
Route::post('checkout', [PageController::class, 'postCheckout'])->name('dathang');				
                


// Route::get('dat-hang',['as'=>'dathang','users'=>'PageController@getCheckout']);
// Route::post('dat-hang',['as'=>'dathang','users'=>'PageController@postCheckout']);